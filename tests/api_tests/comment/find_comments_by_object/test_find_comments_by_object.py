...
class TestFindCommentsByObject:
    ...
    def test_find_comments_by_object_positive(self, comment_steps, create_and_delete_comment):
        params = {
            'objectId': create_and_delete_comment.data.objectId,
    ...
    def test_find_comments_by_object_without_auth(self, comment_steps, create_and_delete_comment):
        params = {
            'objectId': create_and_delete_comment.data.objectId,
            'objectModel': 'humhub\modules\post\models\Post'
        }
