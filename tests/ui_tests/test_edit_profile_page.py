...
class TestEditProfilePage:
    ...
    @pytest.mark.medium
    def test_fill_general_tab(self, dashboard_page, login_modal, account_dropdown, profile_panel, edit_profile_steps):
        ...
        edit_profile_steps.fill_general_tab(GeneralData())
    ...
    def test_fill_communication_tab(self, dashboard_page, login_modal, account_dropdown, profile_panel,
        ...
        account_dropdown.go_to_profile()
        profile_panel.click_edit_account()
        edit_profile_steps.fill_communication_tab(CommunicationData())

    @pytest.mark.medium
    def test_fill_social_tab(self, dashboard_page, login_modal, account_dropdown, profile_panel, edit_profile_steps):
        dashboard_page.open_page()
        login_modal.login_as("yellowlatesummer@gmail.com", "20039915aAa")
        account_dropdown.go_to_profile()
        profile_panel.click_edit_account()
        edit_profile_steps.fill_social_tab(SocialData())
    ...
    def test_required_fields_validation(self, dashboard_page, login_modal, account_dropdown, profile_panel,
        ...
        account_dropdown.go_to_profile()
        profile_panel.click_edit_account()
        edit_profile_steps.validate_required_fields()
